! function(t, e) {
    ...
    var v = o(function(t) {
        ...
        O = (w.version, o(function(t) {
            ...
            w.inspectSource = function(t) {
                ...
                i && (g(n, "name") || L(n, "name", e)), t[e] !== n &&
                (i && (g(n, o) || L(n, o, t[e] ? "" + t[e] : a.join(String(e)))), t === v
                    ? t[e] = n
                    : r
                    ? t[e]
                    ? t[e] = n
    ...
    var te, ee, ne, re, ie, oe, ae, ue, ce, se, le, fe, de, pe, he, ve, ge, ye, me, be, we, Se, _e, Le, Oe, Te, Ie, Ce, ke, Ee, je, xe, Ae = (ee = "ajaxLoad", ne = "coreui.ajaxLoad", re = (te = e).fn[ee], ie = "active", oe = "open", ae = "view-script", ue = "click", ce = ".sidebar-nav .nav-dropdown", se = ".sidebar-nav .nav-link", le = ".sidebar-nav .nav-item", fe = ".view-script", de = {
            ...
            return t.loadPage = function(r) {
                ...
                te.ajax({
                    ...
                    success: function(t) {
                        ...
                        e.querySelectorAll("script").forEach(function(t) {
                            ...
                            0), te(i).html(e), n.length &&
                            function t(e, n) {
                                void 0 === n && (n = 0);
                                var r = document.createElement("script");
                                r.type = "text/javascript", r.src = e[n], r.className = ae, r.onload =
                ...
                te(se).removeClass(ie), te(ce).removeClass(oe),
                    te(ce + ':has(a[href="' + t.replace(/^\//, "").split("?")[0] + '"])').addClass(oe), te(
                        le + ' a[href="' + t.replace(/^\//, "").split("?")[0] + '"]').addClass(ie), this.loadPage(t);
                ...
                te(document).on(ue,
                    se + '[href!=="#"]',
                    function(t) {
                        t.preventDefault(), t.stopPropagation(), "_top" === t.currentTarget.target
    ...
    var Ue, Fe, qe, Ve, Ke, He, Be, ze, Je, $e, We, Ye, Xe, Ze, tn, en, nn, rn, on, an, un, cn, sn, ln, fn = function(t, e) {
        ...
        dn = (Fe = "sidebar", qe = "coreui.sidebar", Ve = (Ue = e).fn[Fe], Ke = 400, He = "active", Be = "brand-minimized", ze = "open", Je = "sidebar-minimized", $e = {
            ...
            function n(t) {
                this._element = t, this.mobile = !1, this.ps =
                    null, this.perfectScrollbar($e.INIT), this.setActiveLink(), this._breakpointTest =
                    this._breakpointTest.bind(this), this._clickOutListener =
                    this._clickOutListener.bind(this), this._addEventListeners(), this._addMediaQuery();
            }
            var t = n.prototype;
            return t.perfectScrollbar = function(t) {
                ...
                if ("undefined" !== typeof r) {
                    ...
                    t !== $e.INIT || n.contains(Je) || (this.ps = this.makeScrollbar()),
                        t === $e.DESTROY && this.destroyScrollbar(), t === $e.TOGGLE &&
                        (n.contains(Je)
                            ? this.destroyScrollbar()
                            : (this.destroyScrollbar(), this.ps = this.makeScrollbar())), t !== $e.UPDATE ||
                            n.contains(Je) ||
                            setTimeout(function() {
                ...
                Ue(on).find(en).each(function(t, e) {
                    var n, r = e;
                    "#" ===
                        (n = r.classList.contains(nn) ? String(window.location) : String(window.location).split("?")[0])
                        .substr(n.length - 1) &&
                        (n = n.slice(0, -1)), Ue(Ue(r))[0].href === n &&
                        Ue(r).addClass(He).parents(Ze).add(r).each(function(t, e) {
                ...
                (t.preventDefault(), t.stopPropagation(), this._removeClickOut(), document.body.classList.remove(
                    "sidebar-show"));
        ...
        pn = function() {
            var t = a(this),
                e = "";
            return t.global && (e += "g"), t.ignoreCase && (e += "i"), t.multiline && (e += "m"), t.unicode &&
                (e += "u"), t.sticky && (e += "y"), e;
        };
    ...
    ! function(t) {
        ...
        return r = 7 === t.length
            ? (e = parseInt(t.substring(1, 3), 16), n =
                parseInt(t.substring(3, 5), 16), parseInt(t.substring(5, 7), 16))
            : (e = parseInt(t.substring(1, 2), 16), n =
                parseInt(t.substring(2, 3), 16), parseInt(t.substring(3, 5), 16)), "rgba(" +
            e +
            ", " +
            n +
            ", " +
        ...
        if (!t.match(/^#(?:[0-9a-f]{3}){1,2}$/i)) throw new Error(t + " is not a valid hex color");
        return i = 7 === t.length
            ? (n = parseInt(t.substring(1, 3), 16), r =
                parseInt(t.substring(3, 5), 16), parseInt(t.substring(5, 7), 16))
            : (n = parseInt(t.substring(1, 2), 16), r =
                parseInt(t.substring(2, 3), 16), parseInt(t.substring(3, 5), 16)), "rgba(" +
            n +
            ", " +
            r +
    ...
    }, t.AjaxLoad = Ae, t.AsideMenu = De, t.Sidebar = dn, Object.defineProperty(t,
        "__esModule",
        {
            value: !0
        });
